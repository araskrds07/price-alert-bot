...
def admin_view(state):
    ...
    text = (f"🛠 <b>Yönetim paneli</b> · v{VERSION}\n\n"
            ...
            "/uzat 12345 · /uzat 12345 sinirsiz\n"
...
COMMANDS = {
    ...
    "id": "id", "uzat": "extend", "admin": "admin", "duyuru": "broadcast", "izinver": "allow", "izinkaldir": "disallow", "ozelmod": "pmode",
}
...
def handle_text(state, ctx, text):
    ...
    if cmd in ("admin", "broadcast", "allow", "disallow", "pmode", "extend"):
        if not is_owner:
